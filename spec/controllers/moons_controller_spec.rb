  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested moon" do
        ...
        Moon.any_instance.should_receive(:update_attributes).with({ "celestial_id" => "1" })
        put :update, {:id => moon.to_param, :moon => { "celestial_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the moon as @moon" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Moon.any_instance.stub(:save).and_return(false)
        put :update, {:id => moon.to_param, :moon => { "celestial_id" => "invalid value" }}, valid_session
        assigns(:moon).should eq(moon)
      end
